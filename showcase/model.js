...
var colonnaBaseArcoB3 = T([0,1,2])([1,2.5,3.6])(CUBOID([2, 1.6, 0.2]));
...
DRAW(STRUCT([colonnaTotale1,colonnaTotale2,pianofinaleTlaslato,pianofinaleTlaslato1,pianofinaleTlaslato2]));

//DRAW(COLOR([0,0.2,0.3])(totaleArco));